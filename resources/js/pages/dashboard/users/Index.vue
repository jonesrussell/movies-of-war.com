...
interface Props {
    ...
    filterDefinitions: Record<string, unknown>[];
...
const initFilters = (): Record<string, string | undefined> => ({
    ...props.filters,
});
const filterValues = ref<Record<string, string | undefined>>(initFilters());
