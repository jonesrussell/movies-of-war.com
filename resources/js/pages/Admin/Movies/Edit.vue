    ...
    <AppLayout>
        ...
        <div class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <p class="mt-2 text-zinc-400">Update {{ movie.title }}</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-2 grid gap-3 sm:grid-cols-3">
                        <label
                            v-for="tag in tags"
                            :key="tag.id"
                            class="flex cursor-pointer items-center gap-2 rounded-lg bg-zinc-900 p-3 hover:bg-zinc-800"
                        >
                            <input
                                v-model="form.tags"
                                type="checkbox"
                ...
                <div>
                    <label class="flex items-center gap-2">
                        ...
                        />
                        <span class="text-sm text-zinc-300"
                            >Mark as upcoming release</span
                        >
                    </label>
                    <div
                        v-if="form.errors.is_upcoming"
                        class="mt-1 text-sm text-red-500"
                    >
