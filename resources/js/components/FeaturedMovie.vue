...
<template>
  <div class="relative overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900/50">
    <div class="absolute right-4 top-4 z-10">
      <span class="inline-flex rounded-full bg-red-600/90 px-3 py-1 text-xs font-bold uppercase tracking-wider text-white backdrop-blur-sm">
        {{ title }}
      </span>
    </div>
    ...
    <div class="grid gap-4 md:grid-cols-3">
      ...
      <div class="flex flex-col justify-center p-6 md:col-span-2">
        ...
        <div v-if="movie.tags && movie.tags.length > 0" class="mb-4 flex flex-wrap gap-1">
          <span
