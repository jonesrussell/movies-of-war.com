...
/**
 * Data Transfer Object for X Mentions Response.
 */
readonly class XMentionsResponse
{
    /**
    ...
    /**
     * Create from X API mentions response.
     *
    ...
    {
        return [
            'data' => $this->tweets->map(fn (XTweetData $t) => $t->toArray())->values()->all(),
            'includes' => [
