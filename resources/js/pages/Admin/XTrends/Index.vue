...
import type { PaginatedXTrendKeywords, XTrendKeyword, XTrendResult } from '@/types/models';
...
function searchKeyword(keyword: XTrendKeyword) {
    if (confirm(`Search for keyword: ${keyword.keyword}?`)) {
        router.post(`/x-trends/${keyword.id}/search`, {}, { preserveScroll: true });
    }
}
        ...
        <div class="w-full px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 rounded-lg bg-zinc-900 p-6">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="text-xl font-bold text-white">Monitored Keywords</h2>
                    <button
                ...
                <div v-if="keywords.data.length === 0" class="text-center text-zinc-400">
                ...
                <div v-else class="space-y-2">
                    ...
                    >
                        <div>
                            <div class="font-medium text-white">{{ keyword.keyword }}</div>
                            <div class="mt-1 text-sm text-zinc-400">
                                Type: {{ keyword.type }} | Results: {{ keyword.results_count ?? 0 }}
                            </div>
                        </div>
                        <div class="flex gap-2">
                            ...
                            <button
                                ...
                                :class="keyword.is_active ? 'text-green-500' : 'text-zinc-500'"
                            >
            ...
            <div class="rounded-lg bg-zinc-900 p-6">
                ...
                <div v-if="recentTrends.length === 0" class="text-center text-zinc-400">
                ...
                <div v-else class="space-y-4">
                    ...
                    >
                        ...
                        <div class="mt-2 text-sm text-zinc-400">
                            @{{ trend.author_username }} | Likes: {{ trend.like_count }} |
